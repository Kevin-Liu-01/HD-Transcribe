...
function About() {
  return (
    <div className="min-h-screen bg-gradient-to-b  from-white to-gray-200 pb-10">
      {/*header section*/}
      ...
      <div className=" max-w-7xl  mx-4 md:mx-8 xl:mx-auto pb-12 ">
        <div className="">
          ...
          <p className="mt-4 max-w-5xl text-xl text-gray-500 ">
            ...
            transcripts of their words. Therefore, it will be able to interpret
            HD patients&apos; specific patterns of speech and produce
            transcripts of their words, facilitating communication between these
            patients and their loved ones.
          </p>
        </div>
        <div className="border border-x-0 border-t-0 border-b-2 border-gray-300 mt-10"></div>
        <div className="mt-12 rounded-xl">
          <dl className="m-4 space-y-10 md:grid md:grid-rows-3 md:gap-x-4 md:gap-y-10 md:space-y-0">
            <div className="relative">
              ...
              <dd className="mt-2 ml-16 text-base text-gray-900">
                ...
                patients to communicate with others more easily. As the disease
                progresses, individuals may have difficulty speaking clearly or
                may have difficulty controlling the movements of their mouth and
                throat, making it difficult for others to understand them. By
                using this tool to convert their speech into written text, they
                can communicate more effectively and with less frustration.
              </dd>
            </div>
            ...
            <div className="relative">
              ...
              <dd className="mt-2 ml-16 text-base text-gray-900">
                ...
                such as slurred speech or changes in their vocal pitch. By using
                HD Transcribe to transcribe speech samples over time, doctors
                and caregivers can track these changes and use them to monitor
